...
## Q1
$$\displaylines{y=\sqrt[\large3]{x+1},x=0,x=4,8\\ \\ \Delta x=\frac{4-0}{8}=\frac12\\ \\ \sum_{j=0}^7\frac12f\left(\frac{j}{2}\right)={\displaystyle\sum_{j=0}^7\dfrac12\sqrt[\large3]{\dfrac{j+2}{2}}}}$$
...
## Q4
$$\displaylines{y=\sin\left(\dfrac{\pi x}{2}\right),a=0,b=2,4\\ \\ \Delta x=\frac12\\ \\ \sum_{i=1}^4\frac12f\left(0+\frac{i}{2}\right)\\ \\ {\displaystyle\sum_{i=1}^4\dfrac12\sin\left(\dfrac{i\pi}{4}\right)}}$$
